...
const gamesRpg = videogames.filter(game => game.genders.find ( gender => gender === 'RPG') );
const sumScore = gamesRpg.reduce((acc, score) => acc + score.score, 0);
const media = sumScore / gamesRpg.length;
